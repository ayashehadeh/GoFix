...
class EditDetailsScreen extends StatelessWidget {
  ...
  const EditDetailsScreen({super.key, required this.professional});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: _EditDetailsView(professional: professional),
    );
  }
}

class _EditDetailsView extends StatelessWidget {
  final Professional professional;

  const _EditDetailsView({required this.professional});
